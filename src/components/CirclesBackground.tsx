...
const CirclesBackground = () => {
  return (
    <>
      <div className='absolute opacity-15 inset-[0_0_-100px] h-[3000px]'>
        <div className='bg-noise bg-repeat w-full h-full opacity-40 absolute top-0 bottom-0 left-0 right-0 bg-[size:128px]' />
      </div>
      <LightSource />
      <div className='absolute opacity-25 inset-[0_0_-69px_-6px] overflow-hidden h-[1000px]'>
        <Circle radius='1220' />
        <Circle radius='1020' />
        <Circle radius='820' />
        <Circle radius='620' />
      </div>
      <div className='absolute top-[-30px] left-0 right-0 h-[3000px] overflow-hidden bg-gradient-to-b from-[rgba(18,24,30,0)] from-[-18%] to-[#051218] to-[95%]'>
